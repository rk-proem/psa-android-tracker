 ...
 */
package com.psaanalytics.psa_android_tracker.psa
...
import com.psaanalytics.psa_android_tracker.psa.configuration.ConfigurationBundle
import com.psaanalytics.psa_android_tracker.core.remoteconfiguration.RemoteConfigurationProvider
import com.psaanalytics.psa_android_tracker.psa.configuration.ConfigurationState
import com.psaanalytics.psa_android_tracker.core.remoteconfiguration.RemoteConfigurationBundle
import com.psaanalytics.psa_android_tracker.core.tracker.ServiceProvider
import com.psaanalytics.psa_android_tracker.core.tracker.TrackerWebViewInterface
import com.psaanalytics.psa_android_tracker.psa.configuration.*
...
/**
 * Instance a new Psa tracker for local or remote configuration, and manage multiple trackers.
 */
object Psa {
    // Private properties
     ...
     *
     * IMPORTANT: The [SQLiteEventStore](com.psaanalytics.core.emitter.storage.SQLiteEventStore) will persist all the events that have been tracked but not yet sent.
     ...
     * [.removeUnsentEventsExceptForNamespaces](com.psaanalytics.core.emitter.storage.SQLiteEventStore.removeUnsentEventsExceptForNamespaces)
     * in [SQLiteEventStore](com.psaanalytics.core.emitter.storage.SQLiteEventStore)
     ...
     *
     * To use the tracker as singleton see [Psa.defaultTracker]
     *
     * IMPORTANT: The [SQLiteEventStore](com.psaanalytics.core.emitter.storage.SQLiteEventStore) will persist all the events that have been tracked but not yet sent.
     * Those events are attached to the namespace.
     * If the tracker is removed or the app relaunched with a different namespace, those events can't
     ...
     * (see [Psa.removeTracker]) cannot become the new default tracker, and the operation fails.
     *
     ...
     * the [Psa library for WebViews](https://docs.psa.io/docs/collecting-data/collecting-from-own-applications/webview-tracker/).
