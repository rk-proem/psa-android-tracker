...
import com.psaanalytics.psa_android_tracker.BuildConfig
...
import com.psaanalytics.psa_android_tracker.psa.event.TrackerError
import com.psaanalytics.psa_android_tracker.psa.tracker.DevicePlatform
import com.psaanalytics.psa_android_tracker.psa.tracker.LogLevel
import com.psaanalytics.psa_android_tracker.psa.tracker.LoggerDelegate
import com.psaanalytics.psa_android_tracker.psa.tracker.PlatformContextRetriever
import com.psaanalytics.psa_android_tracker.core.emitter.Emitter
import com.psaanalytics.psa_android_tracker.core.emitter.Executor.execute
import com.psaanalytics.psa_android_tracker.core.gdpr.Gdpr
import com.psaanalytics.psa_android_tracker.core.screenviews.ScreenState
import com.psaanalytics.psa_android_tracker.core.screenviews.ScreenStateMachine
import com.psaanalytics.psa_android_tracker.core.screenviews.ScreenSummaryStateMachine
import com.psaanalytics.psa_android_tracker.core.session.ProcessObserver.Companion.initialize
import com.psaanalytics.psa_android_tracker.core.session.Session
import com.psaanalytics.psa_android_tracker.core.session.Session.Companion.getInstance
import com.psaanalytics.psa_android_tracker.core.statemachine.DeepLinkStateMachine
import com.psaanalytics.psa_android_tracker.core.statemachine.StateManager
import com.psaanalytics.psa_android_tracker.core.utils.NotificationCenter
import com.psaanalytics.psa_android_tracker.psa.configuration.PlatformContextProperty
import java.util.UUID
import com.psaanalytics.psa_android_tracker.core.statemachine.*
import com.psaanalytics.psa_android_tracker.core.tracker.Logger.d
import com.psaanalytics.psa_android_tracker.core.tracker.Logger.updateLogLevel
import com.psaanalytics.psa_android_tracker.core.tracker.Logger.v
import com.psaanalytics.psa_android_tracker.core.utils.NotificationCenter.addObserver
import com.psaanalytics.psa_android_tracker.core.utils.NotificationCenter.removeObserver
import com.psaanalytics.psa_android_tracker.core.utils.Util.getApplicationContext
import com.psaanalytics.psa_android_tracker.core.utils.Util.getGeoLocationContext
import com.psaanalytics.psa_android_tracker.core.utils.Util.truncateUrlScheme
import com.psaanalytics.psa_android_tracker.psa.entity.DeepLink
import com.psaanalytics.psa_android_tracker.psa.event.*
import com.psaanalytics.psa_android_tracker.psa.payload.Payload
import com.psaanalytics.psa_android_tracker.psa.payload.TrackerPayload
import com.psaanalytics.psa_android_tracker.psa.tracker.*
import java.util.concurrent.TimeUnit
import java.util.concurrent.atomic.AtomicBoolean
import com.psaanalytics.psa_android_tracker.psa.util.Basis
import com.psaanalytics.psa_android_tracker.core.tracker.Logger.track
...
/**
 * Builds a Tracker object which is used to send events to a Psa Collector.
 *
...
class Tracker(
   ...
   private var trackerVersion = BuildConfig.TRACKER_LABEL
     ...
     * Create a Tracker directly, not via the Psa interface, to configure timeUnit.
     */
    ...
    /**
     * This configuration option is not published in the TrackerConfiguration class.
     * Create a Tracker directly, not via the Psa interface, to configure sessionCallbacks.
     *
    ...
    private val receiveLifecycleNotification: NotificationCenter.FunctionalObserver = object : NotificationCenter.FunctionalObserver() {
    ...
    private val receiveScreenViewNotification: NotificationCenter.FunctionalObserver = object : NotificationCenter.FunctionalObserver() {
        override fun apply(data: Map<String, Any>) {
    ...
    private val receiveInstallNotification: NotificationCenter.FunctionalObserver = object : NotificationCenter.FunctionalObserver() {
        override fun apply(data: Map<String, Any>) {
    ...
    private val receiveDiagnosticNotification: NotificationCenter.FunctionalObserver = object : NotificationCenter.FunctionalObserver() {
        override fun apply(data: Map<String, Any>) {
    ...
    private val receiveCrashReportingNotification: NotificationCenter.FunctionalObserver =
        object : NotificationCenter.FunctionalObserver() {
            override fun apply(data: Map<String, Any>) {
