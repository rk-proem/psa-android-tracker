...
import com.psaanalytics.psa_android_tracker.core.emitter.NetworkConfigurationInterface
 ...
 * allowing the tracker to be able to send events to the Psa collector.
 * 
 * Default values:
 * 
...
class NetworkConfiguration : NetworkConfigurationInterface, Configuration {
     ...
     * [CollectorCookieJar](com.psaanalytics.psa_android_tracker.psa.network.CollectorCookieJar)
