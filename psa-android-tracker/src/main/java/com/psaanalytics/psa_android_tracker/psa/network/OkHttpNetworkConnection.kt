...
import com.psaanalytics.psa_android_tracker.core.emitter.Executor
import com.psaanalytics.psa_android_tracker.core.emitter.TLSArguments
import com.psaanalytics.psa_android_tracker.core.emitter.TLSVersion

import com.psaanalytics.psa_android_tracker.core.constants.TrackerConstants
import com.psaanalytics.psa_android_tracker.core.emitter.EmitterDefaults
...
class OkHttpNetworkConnection private constructor(builder: OkHttpNetworkConnectionBuilder) :
    ...
    class OkHttpNetworkConnectionBuilder(
         ...
         * [NetworkConfiguration](com.psaanalytics.psa.configuration.NetworkConfiguration) class.
         * Create an Emitter and Tracker directly, not via the 
         * [Psa](com.psaanalytics.psa_android_tracker.psa.Psa) interface, to configure tlsVersions.
        ...
        /**
         * An OkHttp cookie jar to override the default [CollectorCookieJar](com.psaanalytics.psa_android_tracker.psa.network.CollectorCookieJar) that stores
         ...
         * This configuration option is not published in the
         * [NetworkConfiguration](com.psaanalytics.psa.configuration.NetworkConfiguration) class.
         * Instead, configure it via [EmitterConfiguration](com.psaanalytics.psa.configuration.EmitterConfiguration).
